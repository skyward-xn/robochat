...
namespace RoboChat.Win32
{
    public static class FlashWindowExtension
    {
        ...
        public static void FlashWindow(this Window win, bool stopOnActivate = true, UInt32 count = UInt32.MaxValue)
        {
            WindowInteropHelper h = new WindowInteropHelper(win);
            FLASHWINFO info = new FLASHWINFO
            {
                hwnd = h.Handle,
                dwFlags = FLASHW_ALL | (stopOnActivate ? FLASHW_TIMERNOFG : FLASHW_TIMER),
                uCount = count,
                dwTimeout = 0
            };
